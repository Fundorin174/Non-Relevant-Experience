...
function showSlidesAcademy(n) {
	...
	if (n > slidesAcademy.length){slideIndexAcademy = 1}
		if (n < 1) {slideIndexAcademy = slidesAcademy.length}
...
function showSlidesTroops(n) {
	...
	if (n > slidesTroops.length){slideIndexTroops = 1}
		if (n < 1) {slideIndexTroops = slidesTroops.length}
...
function showSlidesBaumana(n) {
	...
	if (n > slidesBaumana.length){slideIndexBaumana = 1}
		if (n < 1) {slideIndexBaumana = slidesBaumana.length}
